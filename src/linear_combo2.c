...
*/    
    //THREAD_END(); 
    //Hand off to red thread
    TRANSITION_TO(task_3_r);
}
/*--------------------------blinker functions------------------------------------*/
